class X
{
	...
	public static int test1()
	{
		...
		i += k++ + i-- + j;
		j += l;
		System.out.println("test1 end: " + "i: " + i + ", " + "j: " + j + "k: " + k + ", " + "l: " + l);
		return i + j + 15;
	}

	public static int test2()
	{
		System.out.println("test2 begin: " + "i: " + i + ", " + "j: " + j + "k: " + k + ", " + "l: " + l);
		i += 6;
		j += --i + --i + j;
		i += k++ + k-- + i + j;
		j += l++;
		...
		i += k++;
		j += --l;
		System.out.println("test2 end: " + "i: " + i + ", " + "j: " + j + "k: " + k + ", " + "l: " + l);
		return i + j + k + l + 18;
	}
	...
	static 
	{
		System.out.println("SIB3 begin: " + "i: " + i + ", " + "j: " + j + "k: " + k + ", " + "l: " + l);
		i += k++;
		j += l;
		main(null);
		...
		i += k + i;
		j += l--;
		System.out.println("SIB3 end: " + "i: " + i + ", " + "j: " + j + "k: " + k + ", " + "l: " + l);
	}
	...
	public static int test4()
	{
		...
		i += --k;
		j += l++;
		System.out.println("test4 end: " + "i: " + i + ", " + "j: " + j + "k: " + k + ", " + "l: " + l);
		return i + j + 16;
	}
}